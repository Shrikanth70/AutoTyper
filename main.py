...
class AutoTyperApp:
        ...
        if current_state == State.READY_TO_TYPE:
            ...
            if text_processor.is_valid_typing_text(clean_text):
                ...
                state_manager.transition_to(
                    State.READY_TO_TYPE, active_source="clipboard"
                )
    ...
    def trigger_copy(self):
        ...
        self.logger.info("Copy shortcut activated.")
    ...
    def trigger_voice(self):
        ...
        if self.voice_engine is None:
            ...
            self.voice_engine = VoiceEngine(
                v_cfg["model_size"], v_cfg["device"], v_cfg["compute_type"]
            )
    ...
    def trigger_l_stop(self):
        if state_manager.state != State.LISTENING:
            return
    ...
    def run_transcription(self, audio_data):
        ...
        if clean_text and not state_manager.stop_event.is_set():
            ...
            notification_manager.notify(
                "AutoTyper", "Voice text ready! Press Ctrl+Alt+V to type."
            )
    ...
    def run(self):
        ...
        menu = Menu(
            ...
            MenuItem(
                ...
                lambda: None,
                enabled=False,
                visible=lambda item: state_manager.state == State.READY_TO_TYPE,
            ),
